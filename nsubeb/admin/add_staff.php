...
<?php require 'helpers/_add_staff.php'; ?>
    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <h1 class="app-page-title text-success">Add a New Staff</h1>
                <hr class="mb-4">
                        ...
                        <div class="app-card app-card-settings shadow-sm p-4">
                            ...
                            <div class="app-card-body">
                                <form class="settings-form" action="" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input name="phone_number" type=text" class="form-control" id="setting-input-3" placeholder="Enter Phone Number" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input name="dob" type="date" class="form-control" id="setting-input-3" placeholder="Enter Date Of Birth" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button name="add_staff" type="submit" class="btn app-btn-primary float-end">Add Staff</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
