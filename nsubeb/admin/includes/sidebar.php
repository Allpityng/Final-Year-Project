<div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="index.php"><img class="logo-icon me-2" src="assets/images/logo.png" alt="logo" /><span class="logo-text">Admin</span></a>
        </div>
        <!--//app-branding-->
            ...
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item">
                                <a class="submenu-link" href="add_staff.php">Add Staff</a>
                            </li>
                            <li class="submenu-item">
                                <a class="submenu-link" href="manage_staffs.php">Manage Staffs</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-3" class="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item">
                                <a class="submenu-link" href="add_department.php">Add Department</a>
                            </li>
                            <li class="submenu-item">
                                <a class="submenu-link" href="manage_department.php">Manage Departments</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="attendance.php">
                        ...
                        <span class="nav-link-text">Attendance</span> </a>
                    <!--//nav-link-->
                </li>
                <!--//nav-item-->
                    <!--//nav-item-->
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="leaves.php">
                        ...
                        <span class="nav-link-text">Leaves</span> </a>
                    <!--//nav-link-->
                </li>
                <!--//nav-item-->
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="contactus.php">
                        ...
                        <span class="nav-link-text">Complains</span> </a>
                    <!--//nav-link-->
                </li>
                <!--//nav-item-->
                <li class="nav-item">
